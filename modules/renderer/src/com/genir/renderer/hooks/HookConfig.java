...
import com.genir.renderer.loaders.ConstantTransformer;
...
public class HookConfig {
  ...
  public static HookRegistry build(
      List<ConstantTransformer> obfTransformers,
      List<ConstantTransformer> starfarerTransformers) {
    HookRegistry reg = new HookRegistry();
    Resolver r = buildResolver();

    // Add resolver-derived member transforms to CP transform lists.
    ConstantTransformer memberCT = new ConstantTransformer(buildMemberTransforms(r));
    ...
    reg.register(
        ...
        Hooks.rewriteConstant("Starsector 0.98a-RC8", "Starsector 0.98a-RC8 FR7.7"));
    ...
    // Upstream adds these via assembly/sound/C.j; here they're added via ASM.
