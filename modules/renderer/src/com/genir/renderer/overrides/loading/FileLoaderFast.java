        ...
        private Pair<String, List<FileHandle>> enumerateLocation(ResourceLocation location) {
            ...
            switch (location.ResourceLocation_type.toString()) {
                ...
                case ABSOLUTE_AND_CWD:
                    ...
                    enumeratePath(Path.of(SAVES_RAW), fileCollector, location); // Saved games.
                    enumeratePath(Path.of(MODS_RAW).resolve("enabled_mods.json"), fileCollector, location); // Enabled mods list.
