...
import com.genir.renderer.agent.ObfTransformations;
import java.io.File;
...
public class HookConfig {
  ...
  public static HookRegistry build() {
    ...
    reg.register(
        ...
        Hooks.rewriteConstant("Starsector 0.98a-RC8", "Starsector 0.98a-RC8 FR8.7rc1"));
    ...
    // LayeredRenderer: replace renderOnly body with FR dispatch
    // (formerly assembly/com/fs/graphics/LayeredRenderer.j)
    reg.register(
    ...
    String addScript = r.method("ScriptStore", "queueScript");
    reg.register(
    ...
    // (formerly assembly/com/fs/starfarer/loading/oO0O.j)
    ...
    // (formerly assembly/com/fs/starfarer/api/impl/combat/threat/RoilingSwarmEffect.j)
    reg.register(
    ...
    reg.register(
        ...
        Hooks.wrapMethod(
            ...
            "loadTexture_vanilla",
            "com/genir/renderer/overrides/loading/textures/TextureLoader",
            "loadTexture",
    ...
    // Used by Tesselation.renderAsPolygon() to cache tessellation results.
    ...
    // (formerly assembly/com/fs/starfarer/combat/entities/Ship.j)
    // Enables cached tessellation rendering for ship bounds.
    ...
    // (formerly assembly/com/fs/starfarer/BaseGameState.j)
    reg.register(
    ...
    // (formerly assembly/com/fs/starfarer/loading/ResourceLoaderState.j)
    ...
    reg.register(
        ...
        Hooks.compose(
            Hooks.widenAccess(),
            // v0.8.0: vanilla init body renamed to init_vanilla, still called by
            // ResourceLoader.init (which delegates from the new init below).
            Hooks.renameMethod("init", "(Ljava/util/Map;)V", "init_vanilla"),
            Hooks.intercept(
                "init_vanilla",
                "(Ljava/util/Map;)V",
                "com/fs/starfarer/loading/scripts/ScriptStore",
  ...
  private static Resolver buildResolver() {
                ...
                .anyMatch(
                    m ->
                        m.desc.contains("Lcom/fs/starfarer/campaign/fleet/FleetMember;")
                            ...
                            && m.desc.startsWith("(Lcom/fs/starfarer/combat/ai/admiral/")));
    ...
    r.resolveMethod("ScriptStore", "queueScript", "(Ljava/lang/String;)V");
    ...
    r.resolveMethod("TextureHandler", "setColor1", "(Ljava/awt/Color;)V", 0);
    r.resolveMethod("TextureHandler", "setColor0", "(Ljava/awt/Color;)V", 1);
    r.resolveMethod("TextureHandler", "setColor2", "(Ljava/awt/Color;)V", 2);
    ...
    // StarfarerSettings getBooleanValue: 2nd (Ljava/lang/String;)Z method.
    r.resolveMethod("StarfarerSettings", "getBooleanValue", "(Ljava/lang/String;)Z", 1);

    // Init epilogue classes: class names from TSV, init = static ()V by ordinal
    // (verified 1/2/2/2 across all three platforms).
    r.registerClass("AtmosphereRenderer", ObfTransformations.classOf("AtmosphereRenderer"));
    r.registerClass("ScreenshotUtil", ObfTransformations.classOf("ScreenshotUtil"));
    r.registerClass("ShipArrowRenderer", ObfTransformations.classOf("ShipArrowRenderer"));
    r.registerClass("ImpactSound", ObfTransformations.classOf("ImpactSound"));
    r.resolveMethod("AtmosphereRenderer", "init", "()V", 1);
    r.resolveMethod("ScreenshotUtil", "init", "()V", 2);
    r.resolveMethod("ShipArrowRenderer", "init", "()V", 2);
    r.resolveMethod("ImpactSound", "init", "()V", 2);
    ...
    String soundStore = ObfTransformations.classOf("SoundStore");
    String soundBuffer = ObfTransformations.classOf("SoundBuffer");
    String track = ObfTransformations.classOf("Track");
    String oggLoader = ObfTransformations.classOf("OggLoader");
    r.registerClass("SoundStore", soundStore);
    r.registerClass("SoundBuffer", soundBuffer);
    r.registerClass("Track", track);
    r.registerClass("OggLoader", oggLoader);
    // SoundStore_getInstance: static method returning the SoundStore class itself.
    r.resolveMethod("SoundStore", "getInstance", "()L" + soundStore + ";");
    // SoundStore_getIsInitialized: 3rd ()Z method (oO0000, ÕO0000, o00000).
    r.resolveMethod("SoundStore", "getIsInitialized", "()Z", 2);
    // SoundStore_loadWav: 2nd (String, InputStream) method returning Track.
    r.resolveMethod("SoundStore", "loadWav",
        "(Ljava/lang/String;Ljava/io/InputStream;)L" + track + ";", 1);
    // SoundStore fields: isOpenALInitialized2 = 2nd Z field, trackMap = unique HashMap.
    r.resolveField("SoundStore", "isOpenALInitialized2", "Z", 1);
    r.resolveField("SoundStore", "trackMap", "Ljava/util/HashMap;");
    // SoundBuffer fields: buffer=unique ByteBuffer, freq=1st I, channels=2nd I.
    r.resolveField("SoundBuffer", "buffer", "Ljava/nio/ByteBuffer;");
    r.resolveField("SoundBuffer", "freq", "I", 0);
    r.resolveField("SoundBuffer", "channels", "I", 1);
    // OggLoader_load: unique (InputStream) method returning SoundBuffer.
    r.resolveMethod("OggLoader", "load",
        "(Ljava/io/InputStream;)L" + soundBuffer + ";");

    return r;
  }

  /** Build CP transforms mapping FR proxy member names to resolved obfuscated names. */
  public static Map<String, String> buildMemberTransforms() {
    return buildMemberTransforms(buildResolver());
  }

  private static Map<String, String> buildMemberTransforms(Resolver r) {
    Map<String, String> t = new HashMap<>();
    // TextureHandler
    t.put("TextureHandler_getTextureID", r.method("TextureHandler", "getTextureID"));
    t.put("TextureHandler_setPath", r.method("TextureHandler", "setPath"));
    t.put("TextureHandler_setHeight", r.method("TextureHandler", "setHeight"));
    t.put("TextureHandler_setWidth", r.method("TextureHandler", "setWidth"));
    t.put("TextureHandler_setImageHeight", r.method("TextureHandler", "setImageHeight"));
    t.put("TextureHandler_setImageWidth", r.method("TextureHandler", "setImageWidth"));
    t.put("TextureHandler_setColor0", r.method("TextureHandler", "setColor0"));
    t.put("TextureHandler_setColor1", r.method("TextureHandler", "setColor1"));
    t.put("TextureHandler_setColor2", r.method("TextureHandler", "setColor2"));
    t.put("TextureHandler_setStringID", r.method("TextureHandler", "setStringID"));
    // FileRepository
    t.put("FileRepository_loadImage", r.method("FileRepository", "loadImage"));
    t.put("FileRepository_loadSound", r.method("FileRepository", "loadSound"));
    // TextureRepository
    t.put("TextureRepository_addTexture", r.method("TextureRepository", "addTexture"));
    // FontRepository
    t.put("FontRepository_defineFont", r.method("FontRepository", "defineFont"));
    // StarfarerSettings
    t.put("StarfarerSettings_getFloatValue", r.method("StarfarerSettings", "getFloatValue"));
    t.put("StarfarerSettings_getBooleanValue", r.method("StarfarerSettings", "getBooleanValue"));
    // Init epilogue statics (ResourceLoader.initEpilogue)
    t.put("ImpactSound_init", r.method("ImpactSound", "init"));
    t.put("AtmosphereRenderer_init", r.method("AtmosphereRenderer", "init"));
    t.put("ScreenshotUtil_init", r.method("ScreenshotUtil", "init"));
    t.put("ShipArrowRenderer_init", r.method("ShipArrowRenderer", "init"));
    // ScriptStore
    t.put("ScriptStore_getSecureClassLoader", r.method("ScriptStore", "getSecureClassLoader"));
    t.put("ScriptStore_getScriptList", r.method("ScriptStore", "getScriptList"));
    t.put("ScriptStore_getPluginSet", r.method("ScriptStore", "getPluginSet"));
    t.put("ScriptStore_objectRepository", r.field("ScriptStore", "objectRepository"));
    t.put("ScriptStore_javaSourceClassLoader", r.field("ScriptStore", "javaSourceClassLoader"));
    // SpecStore
    t.put("SpecStore_init", r.method("SpecStore", "init"));
    // ResourceLocation
    t.put("ResourceLocation_type", r.field("ResourceLocation", "type"));
    t.put("ResourceLocation_path", r.field("ResourceLocation", "path"));
    t.put("ResourceLocation_isMod", r.field("ResourceLocation", "isMod"));
    // ResourceLoader / FileUtils (same class: com/fs/util/C)
    t.put("ResourceLoader_locationFilter", r.field("ResourceLoader", "locationFilter"));
    ...
    // ProgressBar
    t.put("ProgressBar_setDescription", r.method("ProgressBar", "setDescription"));
    t.put("ProgressBar_render", r.method("ProgressBar", "renderProgress"));
    t.put("ProgressBar_renderWithDescription", r.method("ProgressBar", "render"));
    // DeploymentManager
    t.put("DeploymentManager_pickReinforcement", r.method("DeploymentManager", "pickReinforcement"));
    // TextureLoader
    t.put("TextureLoader_loadTexture", r.method("TextureLoader", "loadTexture"));
    // TextureTransformer
    t.put("TextureTransformer_apply", r.method("TextureTransformer", "apply"));
    // Sound (v0.7.6+)
    t.put("SoundStore_getInstance", r.method("SoundStore", "getInstance"));
    t.put("SoundStore_getIsInitialized", r.method("SoundStore", "getIsInitialized"));
    t.put("SoundStore_loadWav", r.method("SoundStore", "loadWav"));
    t.put("SoundBuffer_buffer", r.field("SoundBuffer", "buffer"));
    t.put("SoundBuffer_freq", r.field("SoundBuffer", "freq"));
    t.put("SoundBuffer_channels", r.field("SoundBuffer", "channels"));
    t.put("OggLoader_load", r.method("OggLoader", "load"));
    return t;
  }
}
